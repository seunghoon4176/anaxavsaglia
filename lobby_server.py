...
class Room:
    ...
    def start_game(self):
        ...
        try:
            ...
            # 게임 서버 시작
            self.game_server = GameServer('localhost', self.game_port)
            self.game_thread = threading.Thread(target=self.game_server.start, daemon=False)
            ...
            self.status = "playing"
            print(f"방 {self.room_id}에서 게임이 시작되었습니다 (포트: {self.game_port})")
            
            return True
            
        except Exception as e:
            print(f"게임 서버 시작 실패: {e}")
            return False
    ...
    def stop_game(self):
        ...
        print(f"방 {self.room_id}의 게임이 종료되었습니다")
...
class LobbyServer:
    ...
    def start(self):
        ...
        try:
            ...
            print(f"로비 서버가 {self.host}:{self.port}에서 시작되었습니다...")
